...
| 仪表盘 | 设置页 |
|--------|--------|
| ![仪表盘](screenshots/dashboard.png) | ![设置页](screenshots/settings.png) |
...
| 暗色 | 亮色 | 海洋蓝 | 森林绿 |
|------|------|--------|--------|
| ![暗色](screenshots/theme-dark.png) | ![亮色](screenshots/theme-light.png) | ![海洋蓝](screenshots/theme-ocean.png) | ![森林绿](screenshots/theme-forest.png) |

| 暖金日落 | 樱花粉 | 薰衣草紫 |
|----------|--------|----------|
| ![暖金日落](screenshots/theme-sunset.png) | ![樱花粉](screenshots/theme-sakura.png) | *待补充* |
